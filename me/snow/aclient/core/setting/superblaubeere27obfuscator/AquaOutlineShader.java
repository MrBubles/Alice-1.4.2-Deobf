...
public final class AquaOutlineShader
    ...
    public static final AquaOutlineShader Field1447 = new AquaOutlineShader();
    public float Field1448 = 0.0f;
    ...
    public void Method2164157(Color color, float f, float f2, boolean bl, int n2, float f3, int n3, double d) {
        ...
        GL20.glUniform1f((int) this.Method2164199("time"), (float) this.Field1448);
        ...
        GL20.glUniform1i((int) this.Method2164199("lines"), (int) n3);
        GL20.glUniform1f((int) this.Method2164199("tau"), (float) ((float) d));
    }

    public void Method2164158(Color color, float f, float f2, boolean bl, int n2, float f3, int n3, double d) {
        ...
        this.Method2164159(color, f, f2, bl, n2, f3, n3, d);
    ...
    public void Method2164159(Color color, float f, float f2, boolean bl, int n2, float f3, int n3, double d) {
        GL11.glPushMatrix();
        ...
        this.Method2164157(color, f, f2, bl, n2, f3, n3, d);
    }

    public void Method2164150(double d) {
        this.Field1448 = (float) ((double) this.Field1448 + d);
    }
}
