...
public class PhBooleanButton
        extends PhButton {
    private final Setting Field627;

    public PhBooleanButton(Setting setting) {
        super(setting.getName());
        this.Field627 = setting;
        this.Field1218 = 15;
    }
    ...
    public void Method2159983(int n2, int n3, float f) {
        ...
        AliceMain.Field766.Method2150317(this.Method2150361(), this.Field1216 + 2.3f, this.Field1217 - 1.7f - (float) PhobosGui.IIllIllIIllIlIIlIlIIlllIllIIllIIllIlIIllIIIllIIIllIIllIIIlIllIIlIIlllIllIIlIllIllIIlIIlIlIIIlIllIIllIlllIllIIIllIIlIIlllIllIIlIIIlIIllIIllIIlIlIIlIllIIlllIlIIlllIIlIlIIlIIlIlllIIlIIIlIIllIllIlllIIlllIIIlIIllIIIlll().IlIIIlIIllIlllIlIIIlIIlllIIlIllIIlIIllIIIlllIIlllIIIlIIIlIIllIlllIIllIllIIIlllIlIllIIIlllIIlllIlIIllIIIllIlIIlIlllIllIIlIIllIllIlIlIIlIIIllIIllIIlIllIIllIIlIIlllIllIIIllIlllIIllIlllIlIIlIllIIlllIIIllIlllIIIllIIlIIllIlllIIll(), this.Method2159968() ? -1 : -5592406);
    }

    @Override
    public void Method2159986() {
        this.Method2159995(this.Field627.isVisible());
    }
    ...
    public void Method2159967() {
        this.Field627.setValue((Boolean) this.Field627.getValue() == false);
    }

    @Override
    public boolean Method2159968() {
        return (Boolean) this.Field627.getValue();
    }
}
