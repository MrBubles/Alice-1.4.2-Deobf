...
public final class Default
    ...
    public static final Default Field1569 = new Default();
    public float Field1570 = 0.0f;
    ...
    public void Method2164169(Color color, float f, float f2, boolean bl, int n2, float f3) {
        ...
        GL20.glUniform1f((int) this.Method2164199("time"), (float) this.Field1570);
    }

    public void Method2164160(Color color, float f, float f2, boolean bl, int n2, float f3) {
        ...
        this.Method2164171(color, f, f2, bl, n2, f3);
    ...
    public void Method2164171(Color color, float f, float f2, boolean bl, int n2, float f3) {
        GL11.glPushMatrix();
        ...
        this.Method2164169(color, f, f2, bl, n2, f3);
    }

    public void Method2164172(double d) {
        this.Field1570 = (float) ((double) this.Field1570 + d);
    }
}
