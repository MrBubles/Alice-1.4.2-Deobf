...
public class BindButton
        extends Button {
    private final Setting Field3108;
    public boolean Field3109;

    public BindButton(Setting setting) {
        super(setting.getName());
        this.Field3108 = setting;
        this.Field1239 = 13;
    }
    ...
    public void Method2159915(int n2, int n3, float f) {
        if (ClickGui2.Method2150488().Field1682.getValue().booleanValue()) {
            ...
            if (ClickGui2.Method2150488().Field1711.getValue().booleanValue()) {
                int n6 = ColorUtil.Method2163370(ClickGui2.Method2150488().Field1712.getValue(), ClickGui2.Method2150488().Field1713.getValue(), ClickGui2.Method2150488().Field1714.getValue(), ClickGui2.Method2150488().Field1715.getValue());
                RenderUtil.Method2163027(this.Field1237, this.Field1238, this.Field1237 + 1.0f, this.Field1238 + (float) this.Field1240 + 0.5f, n6);
            }
        }
        if (this.Field3109) {
            AliceMain.Field766.Method2150317("Press a key...", this.Field1237 + 2.3f, this.Field1238 - 1.7f - (float) LuigiGui.IIllIllIIllIlIIlIlIIlllIllIIllIIllIlIIllIIIllIIIllIIllIIIlIllIIlIIlllIllIIlIllIllIIlIIlIlIIIlIllIIllIlllIllIIIllIIlIIlllIllIIlIIIlIIllIIllIIlIlIIlIllIIlllIlIIlllIIlIlIIlIIlIlllIIlIIIlIIllIllIlllIIlllIIIlIIllIIIlll().IlIIIlIIllIlllIlIIIlIIlllIIlIllIIlIIllIIIlllIIlllIIIlIIIlIIllIlllIIllIllIIIlllIlIllIIIlllIIlllIlIIllIIIllIlIIlIlllIllIIlIIllIllIlIlIIlIIIllIIllIIlIllIIllIIlIIlllIllIIIllIlllIIllIlllIlIIlIllIIlllIIIllIlllIIIllIIlIIllIlllIIll(), this.Method2159899() ? -1 : -5592406);
        } else {
            AliceMain.Field766.Method2150317(this.Field3108.getName() + " \u00a77" + this.Field3108.getValue().toString(), this.Field1237 + 2.3f, this.Field1238 - 1.7f - (float) LuigiGui.IIllIllIIllIlIIlIlIIlllIllIIllIIllIlIIllIIIllIIIllIIllIIIlIllIIlIIlllIllIIlIllIllIIlIIlIlIIIlIllIIllIlllIllIIIllIIlIIlllIllIIlIIIlIIllIIllIIlIlIIlIllIIlllIlIIlllIIlIlIIlIIlIlllIIlIIIlIIllIllIlllIIlllIIIlIIllIIIlll().IlIIIlIIllIlllIlIIIlIIlllIIlIllIIlIIllIIIlllIIlllIIIlIIIlIIllIlllIIllIllIIIlllIlIllIIIlllIIlllIlIIllIIIllIlIIlIlllIllIIlIIllIllIlIlIIlIIIllIIllIIlIllIIllIIlIIlllIllIIIllIlllIIllIlllIlIIlIllIIlllIIIllIlllIIIllIIlIIllIlllIIll(), this.Method2159899() ? -1 : -5592406);
        }
    }

    @Override
    public void Method2159918() {
        this.Method2159927(this.Field3108.isVisible());
    }
