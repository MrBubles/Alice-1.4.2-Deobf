...
public class BooleanButtonOld
        extends ButtonOld {
    private final Setting Field2315;

    public BooleanButtonOld(Setting setting) {
        super(setting.getName());
        this.Field2315 = setting;
        this.Field21 = 15;
    }
    ...
    public void Method2159836() {
        this.Method2159845(this.Field2315.isVisible());
    }
    ...
    public void Method2159816() {
        this.Field2315.setValue((Boolean) this.Field2315.getValue() == false);
    }

    @Override
    public boolean Method2159817() {
        return (Boolean) this.Field2315.getValue();
    }
}
