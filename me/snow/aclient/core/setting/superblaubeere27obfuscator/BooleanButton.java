...
public class BooleanButton
        extends Button {
    private final Setting Field3939;

    public BooleanButton(Setting setting) {
        super(setting.getName());
        this.Field3939 = setting;
        this.Field1239 = 13;
    }
    ...
    public void Method2159915(int n2, int n3, float f) {
        ...
        AliceMain.Field766.Method2150317(this.Method2150361(), this.Field1237 + 2.3f, this.Field1238 - 1.7f - (float) LuigiGui.IIllIllIIllIlIIlIlIIlllIllIIllIIllIlIIllIIIllIIIllIIllIIIlIllIIlIIlllIllIIlIllIllIIlIIlIlIIIlIllIIllIlllIllIIIllIIlIIlllIllIIlIIIlIIllIIllIIlIlIIlIllIIlllIlIIlllIIlIlIIlIIlIlllIIlIIIlIIllIllIlllIIlllIIIlIIllIIIlll().IlIIIlIIllIlllIlIIIlIIlllIIlIllIIlIIllIIIlllIIlllIIIlIIIlIIllIlllIIllIllIIIlllIlIllIIIlllIIlllIlIIllIIIllIlIIlIlllIllIIlIIllIllIlIlIIlIIIllIIllIIlIllIIllIIlIIlllIllIIIllIlllIIllIlllIlIIlIllIIlllIIIllIlllIIIllIIlIIllIlllIIll(), this.Method2159899() ? -1 : -5592406);
    }

    @Override
    public void Method2159918() {
        this.Method2159927(this.Field3939.isVisible());
    }
    ...
    public void Method2159898() {
        this.Field3939.setValue((Boolean) this.Field3939.getValue() == false);
    }

    @Override
    public boolean Method2159899() {
        return (Boolean) this.Field3939.getValue();
    }
}
