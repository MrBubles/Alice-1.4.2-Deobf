...
public class EnumButtonF
        extends ButtonF {
    public Setting Field2038;

    public EnumButtonF(Setting setting) {
        super(setting.getName());
        this.Field2038 = setting;
        this.Field1551 = 13;
    }
    ...
    public void Method2159752(int n2, int n3, float f) {
        ...
        AliceMain.Field766.Method2150317(this.Field2038.getName() + " \u00a77" + this.Field2038.currentEnumName(), this.Field1549 + 2.3f, this.Field1550 - 1.7f - (float) FutureGui.IIllIllIIllIlIIlIlIIlllIllIIllIIllIlIIllIIIllIIIllIIllIIIlIllIIlIIlllIllIIlIllIllIIlIIlIlIIIlIllIIllIlllIllIIIllIIlIIlllIllIIlIIIlIIllIIllIIlIlIIlIllIIlllIlIIlllIIlIlIIlIIlIlllIIlIIIlIIllIllIlllIIlllIIIlIIllIIIlll().IlIIIlIIllIlllIlIIIlIIlllIIlIllIIlIIllIIIlllIIlllIIIlIIIlIIllIlllIIllIllIIIlllIlIllIIIlllIIlllIlIIllIIIllIlIIlIlllIllIIlIIllIllIlIlIIlIIIllIIllIIlIllIIllIIlIIlllIllIIIllIlllIIllIlllIlIIlIllIIlllIIIllIlllIIIllIIlIIllIlllIIll(), this.Method2159735() ? -1 : -5592406);
    }

    @Override
    public void Method2159755() {
        this.Method2159764(this.Field2038.isVisible());
    }
