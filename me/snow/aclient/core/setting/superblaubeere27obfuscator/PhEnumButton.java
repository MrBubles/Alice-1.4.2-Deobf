...
public class PhEnumButton
        extends PhButton {
    public Setting Field2889;

    public PhEnumButton(Setting setting) {
        super(setting.getName());
        this.Field2889 = setting;
        this.Field1218 = 15;
    }
    ...
    public void Method2159983(int n2, int n3, float f) {
        ...
        AliceMain.Field766.Method2150317(this.Field2889.getName() + " \u00a77" + this.Field2889.currentEnumName(), this.Field1216 + 2.3f, this.Field1217 - 1.7f - (float) PhobosGui.IIllIllIIllIlIIlIlIIlllIllIIllIIllIlIIllIIIllIIIllIIllIIIlIllIIlIIlllIllIIlIllIllIIlIIlIlIIIlIllIIllIlllIllIIIllIIlIIlllIllIIlIIIlIIllIIllIIlIlIIlIllIIlllIlIIlllIIlIlIIlIIlIlllIIlIIIlIIllIllIlllIIlllIIIlIIllIIIlll().IlIIIlIIllIlllIlIIIlIIlllIIlIllIIlIIllIIIlllIIlllIIIlIIIlIIllIlllIIllIllIIIlllIlIllIIIlllIIlllIlIIllIIIllIlIIlIlllIllIIlIIllIllIlIlIIlIIIllIIllIIlIllIIllIIlIIlllIllIIIllIlllIIllIlllIlIIlIllIIlllIIIllIlllIIIllIIlIIllIlllIIll(), this.Method2159968() ? -1 : -5592406);
    }

    @Override
    public void Method2159986() {
        this.Method2159995(this.Field2889.isVisible());
    }
